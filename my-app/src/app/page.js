...
export default function Home() {
    ...
    return (
        <div className="w-full h-screen overflow-y-scroll snap-y snap-mandatory bg-white text-black">
            <main className="flex flex-col items-center">
                <section key={0} className="h-screen pt-10 flex items-center justify-center snap-start">
                    <motion.div
                        className="text-center"
                        initial={{ opacity: 0, y: 50 }}
                        animate={{ opacity: currentIndex === 0 ? 1 : 0.3, y: currentIndex === 0 ? 0 : 50 }}
                ...
                <section key={1} className="flex items-center justify-center snap-start">
                    <motion.div
                        className="text-center"
                        initial={{ opacity: 0, y: 50 }}
                        animate={{ opacity: currentIndex === 0 ? 1 : 0.3, y: currentIndex === 0 ? 0 : 50 }}
                ...
                <section key={2} className="h-screen flex items-center justify-center snap-start">
                    <motion.div
                        className="text-center"
                        initial={{ opacity: 0, y: 50 }}
                ...
                <section key={3} className="h-screen flex items-center justify-center snap-start">
                    <motion.div
                        className="text-center"
                        initial={{ opacity: 0, y: 50 }}
                        animate={{ opacity: currentIndex === 0 ? 1 : 0.3, y: currentIndex === 0 ? 0 : 50 }}
